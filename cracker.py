# подключаю библиотеку для работы с архивами
import zipfile
...
print ("Данный код охраняеться политиками открытого программного обеспечения! При копировании просим учитывать данный факт!")
count = 1
